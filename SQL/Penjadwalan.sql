...
WHERE nama_dosen = 'Dika Riazky Yunianto Skom., MKom.')
WHERE kode_mk = '02010'
...
UPDATE mk SET nama_mk = 'Basis Data Dasar' WHERE nama_mk = 'Basis Data';
SELECT * FROM mk

UPDATE jadwal SET jp_mulai = 5, jp_selesai = 10 WHERE kode_mk = '02010'

SELECT * FROM jadwal

DELETE FROM jadwal WHERE kode_mk = '02016';

INSERT INTO mk VALUES ('02042', 'Pancasila'), ('02043', 'Bela Negara'), ('02044', 'Wawasan Nusantara');
